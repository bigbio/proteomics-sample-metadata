...
This document provides guidelines for annotating data file metadata in SDRF-Proteomics format. These conventions define standardized approaches for describing MS run files, instrument settings, and analysis parameters.
...
Data file metadata conventions define standardized formats for properties that describe the relationship between samples and data files, instrument configurations, and analysis parameters. This convention covers:
...
For sample metadata conventions (organism, age, sex, disease), see link:sample-metadata-conventions.adoc[Sample Metadata Conventions].
...
- https://github.com/bigbio/proteomics-sample-metadata/blob/master/annotated-projects/PXD000612/PXD000612.sdrf.tsv[Label free example]
- https://github.com/bigbio/proteomics-sample-metadata/blob/master/annotated-projects/PXD011799/PXD011799.sdrf.tsv[TMT example]
- https://github.com/bigbio/proteomics-sample-metadata/blob/master/annotated-projects/PXD017710/PXD017710-silac.sdrf.tsv[SILAC example]
