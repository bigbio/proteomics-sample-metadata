...
|**TECHNOLOGY** (required)
|https://github.com/bigbio/sdrf-templates/tree/main/ms-proteomics[ms-proteomics], https://github.com/bigbio/sdrf-templates/tree/main/affinity-proteomics[affinity-proteomics], https://github.com/bigbio/sdrf-templates/tree/main/ms-metabolomics[ms-metabolomics]
...
- https://github.com/bigbio/sdrf-templates/tree/main/affinity-proteomics[Affinity Proteomics] - Olink and SomaScan-style platform metadata
...
- https://github.com/bigbio/sdrf-templates/tree/main/lc-ms-metabolomics[LC-MS Metabolomics] - chromatography, ion source, polarity, scan range
- https://github.com/bigbio/sdrf-templates/tree/main/gc-ms-metabolomics[GC-MS Metabolomics] - derivatization, GC column, carrier gas, oven program
