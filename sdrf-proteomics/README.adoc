...
- *characteristics[organism part]*: The main normalized anatomical term for the sample (e.g., liver). Values SHOULD come from https://www.ebi.ac.uk/ols4/ontologies/uberon[UBERON] or https://www.ebi.ac.uk/ols4/ontologies/bto[BTO]. Use the clearest ontology-backed anatomy term available for cross-study integration; more specific provenance can be captured separately in `characteristics[sampling site]`.
