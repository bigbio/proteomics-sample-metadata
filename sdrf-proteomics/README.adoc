...
image::https://github.com/ypriverol/proteomics-metadata-standard/raw/master/sdrf-proteomics/images/sample-metadata.png[]
...
The https://github.com/ypriverol/proteomics-metadata-standard/tree/master/templates[SDRF-Proteomics templates] defines a set of templates and checklists of properties that should be provided depending on the proteomics experiment.
...
Please visit the following document to read about SDRF-Proteomics use cases, templates and https://github.com/ypriverol/proteomics-metadata-standard/blob/master/templates/README.adoc[checklists].
