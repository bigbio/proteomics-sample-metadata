...
1. Choose a <<templates,technology template>> based on your <<technology-type,technology type>>: `ms-proteomics` for _proteomic profiling by mass spectrometry_, `affinity-proteomics` for _protein expression profiling by antibody/aptamer array_ (Olink, SomaScan)
