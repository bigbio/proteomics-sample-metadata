...
* https://github.com/bigbio/proteomics-metadata-standard/tree/master/sdrf-proteomics/templates[Specialized templates]: Complete schemas for specific experiment types (cell-lines, single-cell, affinity-proteomics, crosslinking, immunopeptidomics, metaproteomics). Each template has its own directory containing:
