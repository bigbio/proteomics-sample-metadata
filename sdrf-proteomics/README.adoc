...
* https://github.com/bigbio/proteomics-sample-metadata/tree/master/templates[Templates]: These are the templates and checklists for specific proteomics experiments (e.g immunopeptidomics). Each template has its own directory containing:
...
| comment[cleavage agent details] | Data | Required | NT=Trypsin;AC=MS:1001251
...
Template file: https://github.com/bigbio/proteomics-sample-metadata/tree/master/templates/core-templates/sdrf-default.sdrf.tsv[sdrf-default.sdrf.tsv]

NOTE: The `characteristics[cell type]` column is optional in the default template but RECOMMENDED when the cell type is known. Use `not available` if the cell type cannot be determined.
...
| characteristics[cell type] | Sample | Required | hepatocyte
| characteristics[biological replicate] | Sample | Required | 1
...
Template file: https://github.com/bigbio/proteomics-sample-metadata/tree/master/templates/core-templates/sdrf-human.sdrf.tsv[sdrf-human.sdrf.tsv]
...
| characteristics[disease] | Sample | Required | normal
| characteristics[cell type] | Sample | Required | neuron
| characteristics[biological replicate] | Sample | Required | 1
...
Template file: https://github.com/bigbio/proteomics-sample-metadata/tree/master/templates/core-templates/sdrf-vertebrates.sdrf.tsv[sdrf-vertebrates.sdrf.tsv]
...
Template file: https://github.com/bigbio/proteomics-sample-metadata/tree/master/templates/core-templates/sdrf-invertebrates.sdrf.tsv[sdrf-invertebrates.sdrf.tsv]
...
Template file: https://github.com/bigbio/proteomics-sample-metadata/tree/master/templates/core-templates/sdrf-plants.sdrf.tsv[sdrf-plants.sdrf.tsv]
...
The template files can be downloaded from the https://github.com/bigbio/proteomics-sample-metadata/tree/master/templates/core-templates[core-templates] folder.
...
For detailed specifications and examples, visit the https://github.com/bigbio/proteomics-sample-metadata/tree/master/templates[Experiment-specific Templates] documentation.
