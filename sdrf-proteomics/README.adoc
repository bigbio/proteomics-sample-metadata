...
This document describe the main specification of SDRF-Proteomics, the structure of the specification [Figure 2], how to contribute, and extend the specification. These are the major components of the SDRF-Proteomics specification:
...
- **Extension**: The extension of the SDRF file SHOULD be .tsv (preferred) or .txt.
