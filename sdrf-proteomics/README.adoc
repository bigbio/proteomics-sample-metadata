...
Additionally, the following OPTIONAL characteristics can be provided to enable better integration with other repositories:

- *characteristics[BioSample Accession]*: The BioSample accession number that identifies the sample in EBI BioSamples database. This enables cross-referencing with other omics datasets and external repositories. Example values include `SAMEA115947232` or `not available` if no BioSample exists.

Example:

|===
| source name   | characteristics[organism] | characteristics[organism part] | characteristics[disease] | characteristics[cell type] | characteristics[BioSample Accession]

|sample_treat   | homo sapiens              | liver                          | liver cancer             | not available             | SAMEA115947232
|sample_control | homo sapiens              | liver                          | liver cancer             | not available             | not available
|===
