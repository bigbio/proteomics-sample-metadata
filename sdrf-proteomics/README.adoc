...
Declare templates using `#template` headers. Only list leaf templates (parents are implied):
...
|Human MS proteomics |`#template=human,version=v1.1.0`
|Mouse MS proteomics |`#template=vertebrates,version=v1.1.0`
|Human crosslinking |`#template=human,version=v1.1.0` + `#template=crosslinking,version=v1.0.0`
|Human Olink |`#template=human,version=v1.1.0` + `#template=olink,version=v1.0.0`
|===
