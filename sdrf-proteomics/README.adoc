...
Further detailed information, including any updates to this document, implementations, and examples is available at https://github.com/bigbio/proteomics-metadata-standard[SDRF GitHub Repository]. The official PSI web page for the document is: https://psidev.info/magetab[HUPO-PSI MAGE-TAB].
...
The official website for SDRF-Proteomics project is https://github.com/bigbio/proteomics-metadata-standard. New use cases, changes to the specification and examples can be added by using Pull requests or issues in GitHub. For users unfamiliar with GitHub, you can also contact the PRIDE team at pride-support@ebi.ac.uk.
