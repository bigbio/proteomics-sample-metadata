...
NOTE: This minimal example shows a **mass spectrometry-based** proteomics experiment. For detailed requirements see the link:templates/ms-proteomics.html[MS-Proteomics template]. For **affinity-based proteomics** (Olink, SomaScan), different columns are required - see the link:templates/affinity-proteomics.html[Affinity-Proteomics template].
...
The following properties MUST be provided for each data file in **mass spectrometry-based proteomics** experiments. For **affinity-based proteomics** (Olink, SomaScan), see the link:templates/affinity-proteomics.html[Affinity-Proteomics template] for different required columns.
...
For detailed documentation of sample preparation and MS/MS fragmentation properties, see the link:templates/ms-proteomics.html[MS-Proteomics Template]:
...
* link:templates/ms-proteomics.html[MS-Proteomics Template] - Detailed guidelines for labels, instruments, modifications, cleavage agents, mass tolerances, RAW file URIs, and other data file properties
...
|link:templates/ms-proteomics.html[ms-proteomics], link:templates/affinity-proteomics.html[affinity-proteomics]
...
| **link:templates/ms-proteomics.html[MS-Proteomics]**
| All mass spectrometry-based proteomics (DDA, DIA, SRM/MRM/PRM)
| link:templates/ms-proteomics.html[Full documentation]
| **Yes** - minimum for MS

| **link:templates/affinity-proteomics.html[Affinity-Proteomics]**
| Affinity-based proteomics (Olink, SomaScan)
| link:templates/affinity-proteomics.html[Full documentation]
