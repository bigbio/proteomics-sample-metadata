...
* https://github.com/bigbio/proteomics-sample-metadata/blob/master/sdrf-proteomics/core-templates[Core templates]: Organism-based templates (human, vertebrates, plants, etc.) that define base schemas for common proteomics experiments. See the <<core-templates,Core Templates>> section.

* https://github.com/bigbio/proteomics-sample-metadata/tree/master/sdrf-proteomics/templates[Specialized templates]: Complete schemas for specific experiment types (cell-lines, single-cell, affinity-proteomics, crosslinking, immunopeptidomics, metaproteomics). Each template has its own directory containing:
- A detailed README.adoc with checklists, and examples.
- A template file ({name}-template.sdrf.tsv) with column headers.

* https://github.com/bigbio/proteomics-sample-metadata/tree/master/sdrf-proteomics/metadata-guidelines[Annotation guidelines]: Detailed documentation for specific metadata annotations (e.g., patient pre-existing condition, sample metadata, data file metadata).
...
* link:metadata-guidelines/human-metadata.adoc[Human Sample Metadata Guidelines] - Human-specific metadata including disease staging, treatment history, demographics, and lifestyle factors
...
Template file: https://github.com/bigbio/proteomics-sample-metadata/tree/master/sdrf-proteomics/core-templates/sdrf-default.sdrf.tsv[sdrf-default.sdrf.tsv]

NOTE: The link:metadata-guidelines/sample-metadata.adoc#cell-type-annotation[characteristics[cell type]] column is optional in the default template but RECOMMENDED when the cell type is known. Use `not available` if the cell type cannot be determined.
...
| link:metadata-guidelines/sample-metadata.adoc#cell-type-annotation[characteristics[cell type]] | Sample | Required | hepatocyte
| characteristics[biological replicate] | Sample | Required | 1
...
| link:metadata-guidelines/human-metadata.adoc#clinical-metadata[characteristics[ancestry category]] | Sample | Recommended | European
| link:metadata-guidelines/human-metadata.adoc#individual-annotation[characteristics[individual]] | Sample | Recommended | P001
...
Template file: https://github.com/bigbio/proteomics-sample-metadata/tree/master/sdrf-proteomics/core-templates/sdrf-human.sdrf.tsv[sdrf-human.sdrf.tsv]
...
| link:metadata-guidelines/sample-metadata.adoc#disease-annotation[characteristics[disease]] | Sample | Required | normal
| link:metadata-guidelines/sample-metadata.adoc#cell-type-annotation[characteristics[cell type]] | Sample | Required | neuron
| characteristics[biological replicate] | Sample | Required | 1
...
Template file: https://github.com/bigbio/proteomics-sample-metadata/tree/master/sdrf-proteomics/core-templates/sdrf-vertebrates.sdrf.tsv[sdrf-vertebrates.sdrf.tsv]
...
Template file: https://github.com/bigbio/proteomics-sample-metadata/tree/master/sdrf-proteomics/core-templates/sdrf-invertebrates.sdrf.tsv[sdrf-invertebrates.sdrf.tsv]
...
Template file: https://github.com/bigbio/proteomics-sample-metadata/tree/master/sdrf-proteomics/core-templates/sdrf-plants.sdrf.tsv[sdrf-plants.sdrf.tsv]
...
The template files can be downloaded from the https://github.com/bigbio/proteomics-sample-metadata/tree/master/sdrf-proteomics/core-templates[core-templates] folder.
