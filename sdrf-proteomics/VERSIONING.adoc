...
For a comprehensive overview of how features move through their lifecycle (Introduction, Test, Unstable, Stable, Deprecation, Removal), please refer to the link:feature_lifecycle.adoc[Feature Lifecycle Policy].
