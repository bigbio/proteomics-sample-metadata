...
|1
|EFO, PRIDE CV
|immunoaffinity purification, immunoaffinity purification (iodoacetamide), mild acid elution, anti-pan HLA class I antibody (W6/32)
...
|0..1
|Free text or MRO ontology (https://www.ebi.ac.uk/ols4/ontologies/mro)
