...
<th class="sample-col">characteristics[HLA typing]</th>
...
ifdef::env-github[]
|===
|source name |characteristics[cell line] |characteristics[MHC class] |characteristics[HLA typing] |... |comment[cell number] |comment[antibody used] |comment[cleavage agent details] |comment[data file]

|JY_cells_rep1 |JY |MHC class I |HLA-A*02:01;HLA-B*07:02;HLA-C*07:02 |... |1e8 cells |W6/32 |not applicable |JY_rep1.raw
|JY_cells_rep2 |JY |MHC class I |HLA-A*02:01;HLA-B*07:02;HLA-C*07:02 |... |1e8 cells |W6/32 |not applicable |JY_rep2.raw
|===
endif::[]
