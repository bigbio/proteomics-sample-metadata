...
|characteristics[individual] |REQUIRED |Unique identifier for the donor individual |sample_01, anonymized, pooled
...
|Olink |Olink Explore HT, Olink Explore 1536, Olink Target 96, Olink Reveal
