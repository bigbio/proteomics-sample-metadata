...
|characteristics[sampling site] |OPTIONAL |Specific anatomical sampling location |UBERON |cervix uteri, fetal kidney, peripheral blood
|comment[passage number] |RECOMMENDED |Passage number of cells used |EFO:0007061 |P15, P20-25, low passage
|comment[cell line source] |OPTIONAL |Source/provider of cell line |EFO:0004443 |ATCC, DSMZ, ECACC, in-house
|===
endif::[]
...
The cell line SDRF template file is available in the sdrf-templates repository:

- link:https://github.com/bigbio/sdrf-templates/blob/main/cell-lines/1.1.0/cell-lines.sdrf.tsv[cell-lines.sdrf.tsv]
