...
The Olink SDRF template file is available in the sdrf-templates repository:

- link:https://github.com/bigbio/sdrf-templates/blob/master/olink/1.0.0/olink.sdrf.tsv[olink.sdrf.tsv]
...
- Olink NPX Documentation: https://olink.com/knowledge/documents
