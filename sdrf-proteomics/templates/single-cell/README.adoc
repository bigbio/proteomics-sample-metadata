...
The single cell proteomics SDRF template file is available in the sdrf-templates repository:

- link:https://github.com/bigbio/sdrf-templates/blob/master/single-cell/1.0.0/single-cell.sdrf.tsv[single-cell.sdrf.tsv]
