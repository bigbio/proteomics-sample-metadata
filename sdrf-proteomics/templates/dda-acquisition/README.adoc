...
The DDA SDRF template file is available in the sdrf-templates repository:

- link:https://github.com/bigbio/sdrf-templates/blob/master/dda-acquisition/1.1.0/dda-acquisition.sdrf.tsv[dda-acquisition.sdrf.tsv]
