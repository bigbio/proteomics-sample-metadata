...
=== Minimal MS Proteomics (non-organism-specific)

|===
|... |comment[sdrf version] |comment[sdrf template]

|... |v1.1.0 |ms-proteomics v1.1.0
|===

=== Human Samples (Recommended)
...
NOTE: The `human` template inherits from `ms-proteomics`, so you only need to specify `human`.

=== With Acquisition-Specific Parameters (multiple templates)
...
|... |v1.1.0 |human v1.1.0 |dda-acquisition v1.1.0
|===
...
The MS-Proteomics SDRF template file is available in the sdrf-templates repository:

- link:https://github.com/bigbio/sdrf-templates/blob/main/ms-proteomics/1.1.0/ms-proteomics.sdrf.tsv[ms-proteomics.sdrf.tsv]
