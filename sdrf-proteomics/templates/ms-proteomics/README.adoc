...
Only list leaf templates in the header; parent templates are implied by inheritance.
...
#file_format=SDRF
#version=v1.1.0
#template=human,dda-acquisition
#template_version=v1.1.0
----

**Version simplification:** Use a single version if all templates share the same version. Only use comma-separated versions when templates have different versions.
