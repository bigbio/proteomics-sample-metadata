...
|characteristics[age] |RECOMMENDED |Age of the donor at sample collection |Sample Metadata
|characteristics[sex] |RECOMMENDED |Biological sex of the donor |Sample Metadata
...
The human SDRF template file is available in the sdrf-templates repository:

- link:https://github.com/bigbio/sdrf-templates/blob/main/human/1.1.0/human.sdrf.tsv[human.sdrf.tsv]
