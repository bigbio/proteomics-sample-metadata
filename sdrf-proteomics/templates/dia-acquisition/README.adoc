...
<td>NT=beam-type collision-induced dissociation;AC=MS:1000422</td>
</tr>
<tr>
...
|comment[dissociation method] |RECOMMENDED |Fragmentation method used |PSI-MS (MS:1000044) |NT=beam-type collision-induced dissociation;AC=MS:1000422
