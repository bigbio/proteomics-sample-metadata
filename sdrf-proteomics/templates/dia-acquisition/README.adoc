...
|comment[collision energy] |OPTIONAL |Collision energy used for fragmentation |PSI-MS (MS:1000045) |27 NCE, 30 eV, 22 NCE;26 NCE;30 NCE
|comment[dissociation method] |OPTIONAL |Fragmentation method used |PRIDE (MS:1000044) |NT=HCD;AC=PRIDE:0000590
