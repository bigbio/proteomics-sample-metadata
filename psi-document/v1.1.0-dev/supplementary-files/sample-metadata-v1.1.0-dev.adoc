...
The `characteristics[tissue]` column should not be used as a replacement for `characteristics[organism part]`. When additional provenance is needed, use `characteristics[sampling site]` alongside `characteristics[organism part]` to capture finer source context.
====
