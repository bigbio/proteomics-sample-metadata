...
See link:templates/ms-proteomics/README.adoc[MS-Proteomics Template] for all available comments.
...
|Other / Not sure
|**ms-proteomics**
|link:templates/ms-proteomics/[Download]
|===
...
For more details, see link:README.adoc#sdrf-file-rules[SDRF File Format] in the specification.
====
...
For complete TMT/iTRAQ documentation, see link:README.adoc#row-uniqueness[Isobaric Labelling] in the specification.
...
For more details, see link:README.adoc#sample-prep-fragmentation[Fractions] in the specification.
...
- Open an issue on https://github.com/bigbio/proteomics-metadata-standard/issues[GitHub] to reach the bigbio team
...
- link:templates/ms-proteomics/README.adoc[MS-Proteomics Template]
...
2. **Read the metadata guidelines** for detailed field descriptions:
   ...
   - link:templates/human/README.adoc[Human Sample Metadata]
   - link:templates/ms-proteomics/README.adoc[Data File Metadata]
