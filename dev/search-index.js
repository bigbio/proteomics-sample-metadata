...
const SEARCH_INDEX = [
  {
    ...
    "keywords": "NCIT characteristics biosample accession number sex proteomics data acquisition method cell type drug grade PRIDE:0000590 pooled sample technology type comment CL MONDO cleavage agent organism individual patient bmi BTO instrument MS ctrl treatment protein disease staging age modification parameters PRIDE:0000832 tissue PRIDE:0000833 UBERON DOID exclamation PRIDE:0000831 MS:1001251 source name PATO developmental stage dose label fraction identifier data file PRIDE:0000834 CLO tumor grade proteomic profiling by mass spectrometry sample factor value PRIDE:0000659 PATO:0000461 ancestry category cleavage agent details organism part dia_scan cell line EFO ... time point MS:1000484 disease technical replicate assay name HANCESTRO biological replicate file your"
  },
  {
    "title": "Sample and Data Relationship Format for Proteomics (SDRF-Proteomics)",
    "content": "// suppress inspection \"GrazieInspection\" for whole file\nSample and Data Relationship Format for Proteomics (SDRF-Proteomics)\n\n//only works on some backends, not HTML\n\n//use style like Section 1 when referencing within the document.\n\n//GitHub specific settings\n\nStatus of this document\n\nThis document provides information to the proteomics community about a proposed standard for sample metadata annotations in public repositories called Sample and Data Relationship Format (SDRF)-Proteomics. Distribution is unlimited.\n\nVersion v1.1.0 - 2025-01\n\nAbstract\n\nThe Human Proteome Organisation (HUPO) Proteomics Standards Initiative (PSI) defines community standards for data representation in proteomics to facilitate data comparison, exchange, and verification. This document presents a specification for the Sample and Data Relationship Format (SDRF-Proteomics).\n\nFurther detailed information, including any updates to this document, implementations, and examples is available at SDRF GitHub Repository. The official PSI web page for the document is: HUPO-PSI SDRF.\n\nMotivation\n\nMany resources have emerged that provide raw or integrated proteomics data in the public domain. If these are valuable individually, their integration through re-analysis represents a huge asset for the community .\n\nUnfortunately, proteomics experimental design and sample related information are often missing in public repositories or stored in very diverse ways and formats. For example:\n\n- The CPTAC Consortium provides for every dataset a set of Excel files with the information on each sample including tumor size, origin, but also how every sample is related to a specific raw file (e.g. instrument configuration parameters).\n\n- As a resource routinely re-analysing public datasets, ProteomicsDB captures for each sample in the database a minimum number of properties to describe the sample and the related experimental protocol such as tissue, digestion method and instrument.\n\nSuch heterogeneity often prevents dat",
    ...
    "section": "Core Specification",
    "keywords": "NCIT biosample accession number sex proteomics data acquisition method cell type grade PRIDE:0000590 pooled sample technology type comment CL MONDO cleavage agent organism individual patient bmi BTO instrument MS factor value treatment tissue disease staging age modification parameters PRIDE:0000832 PRIDE:0000833 UBERON DOID PRIDE:0000831 MS:1001251 source name PATO developmental stage dose label fraction identifier data file PRIDE:0000834 CLO tumor grade PRIDE:0000659 PATO:0000461 ancestry category cleavage agent details organism part cell line EFO ... time point MS:1000484 disease technical replicate assay name HANCESTRO biological replicate"
  },
  {
    ...
    "keywords": "enrichment method stress spiked compound sex mass UBERON:0000955 cell type comment UBERON:0002107 xenograft CL SIO:001012 PRIDE:0000837 CL:0000057 MONDO:0100096 CL:0000236 MONDO organism UBERON:0002113 depletion patient bmi factor value ctrl individual tissue treatment age EFO:0000651 MONDO:0005148 UBERON DOID synthetic peptide CL:0000815 sample preparation MONDO:0004989 exclamation enrichment process smoking status CL:0000084 source name PATO developmental stage CL:0000066 dose PATO:0000461 ancestry category compound organism part UBERON:0000948 material type UBERON:0001969 MONDO:0004975 EFO cell line time point CL:0000624 UBERON:0000178 disease CL:0000235 hs PATO:0000001 biological replicate tissue supergroup phenotype hfd genotype"
  },
  {
    "title": "Sample Metadata Guidelines",
    "content": "Sample Metadata Guidelines\n\nIntroduction\n\nThis document provides guidelines for annotating general sample metadata in SDRF-Proteomics format. These guidelines apply to samples from any organism (human, animal, plant, microorganism).\n\nFor human-specific metadata (disease staging, comorbidities, treatment history), see Human Sample Metadata Guidelines.\n\nVersion 1.1.0 - 2026-01\n\nBest Practices\n\n1. Use lowercase for all controlled vocabulary values (except proper nouns in disease names).\n2. Use ontology terms mapped to MONDO (diseases), CL (cell types), UBERON (anatomy), PATO (phenotypes).\n3. Be consistent with format across all samples in a dataset.\n4. Document unknowns using not available (unknown) or not applicable (not relevant) - never leave cells empty.\n5. Validate before submission using sdrf-pipelines to check ontology mappings.\n\nGeneral Formatting Conventions\n\nCapitalization Rules\n\nMost controlled vocabulary values should be lowercase:\n\n- Organism names: homo sapiens, mus musculus\n- Organism parts: blood, liver, brain\n- Sex values: male, female\n- Developmental stages: adult, embryonic\n- Disease names (general): breast carcinoma, type 2 diabetes mellitus\n\nExceptions (retain proper noun capitalization):\n\n- Disease names with proper nouns: Alzheimer disease, Parkinson disease\n- Ancestry categories (geographic populations): African, European, South Asian\n- Cell line names: HeLa, HEK293, K562\n\n Validators should normalize common capitalization variations (e.g., accept both Homo sapiens and homo sapiens), but submitters should use lowercase for consistency.\n\nReserved Values\n\nThe following reserved values can be used across multiple columns when specific data is unavailable:\n\nValue |When to Use |Example Columns\n\nnot available\nInformation was not collected or is unknown\nage, sex, ancestry category, disease\n\nnot applicable\nThe field does not apply to this sample type\norganism part (for cell lines), cell type (for whole organism)\n\nanonymized\nInformation exists but has be",
    ...
    "section": "Sample Metadata Guidelines",
    "keywords": "enrichment method spiked compound sex mass UBERON:0000955 cell type comment UBERON:0002107 xenograft CL SIO:001012 PRIDE:0000837 CL:0000057 MONDO:0100096 CL:0000236 MONDO organism UBERON:0002113 depletion patient bmi factor value individual tissue treatment age EFO:0000651 MONDO:0005148 UBERON DOID synthetic peptide CL:0000815 sample preparation MONDO:0004989 enrichment process smoking status CL:0000084 source name PATO developmental stage CL:0000066 dose PATO:0000461 ancestry category compound organism part UBERON:0000948 material type UBERON:0001969 MONDO:0004975 EFO cell line time point CL:0000624 UBERON:0000178 disease CL:0000235 PATO:0000001 tissue supergroup phenotype biological replicate genotype"
  },
  {
    ...
    "keywords": "MS:1000044 PRIDE:0000592 PRIDE:0000594 MS2 mass analyzer MS:1000264 fractionation method MS:1001309 PRIDE:0000564 PRIDE:0000590 comment MS1 scan range MS:1001306 PRIDE:0000551 MS:1001303 MS:1001313 depletion collision energy scan window upper limit cleavage agent MS:1002523 instrument PRIDE:0000591 MS MS:1001917 modification parameters PRIDE:0000285 MS:1001045 scan window lower limit exclamation PRIDE:0000565 MS:1001251 PRIDE:0000553 PRIDE:0000561 label fraction identifier PRIDE:0000593 reduction reagent cleavage agent details fragment mass tolerance MS:1000081 MS:1000443 MS:1000084 alkylation reagent precursor mass tolerance dissociation method MS:1000484"
  },
  {
    "title": "Data File Metadata Guidelines",
    "content": "Data File Metadata Guidelines\n\nIntroduction\n\nThis document provides detailed guidelines for data file metadata fields that require specific formatting or have complex standardization requirements. For basic field descriptions, see the main SDRF-Proteomics specification.\n\nVersion 1.0.0 - 2025-01\n\nBest Practices\n\n1. Use ontology terms - Prefer PSI-MS and PRIDE ontology terms for labels and enzymes.\n2. Document modifications - Include all expected modifications with UNIMOD accessions.\n3. Provide mass tolerances - Include precursor and fragment tolerances for reproducibility.\n\nCV Term Format\n\nFor data file metadata columns that reference ontology terms, use the structured CV term format:\n\nNT={term name};AC={accession}\n\nExamples:\n\n- Dissociation method: NT=HCD;AC=PRIDE:0000590\n- Fractionation method: NT=High-pH reversed-phase chromatography;AC=PRIDE:0000564\n- Instrument: NT=Q Exactive HF;AC=MS:1002523\n- Label: NT=TMT126;AC=PRIDE:0000285\n\nWhy use the structured format?\n\n1. Automated annotation: Many data file properties (instrument, acquisition method, dissociation method) can be automatically determined by software from raw files.\n2. Validation: Accession numbers enable automated validation against ontologies.\n3. Interoperability: Structured terms are unambiguous across different tools and databases.\n\n Unlike sample metadata (characteristics) which are typically annotated manually using simple term names, data file metadata benefits from the structured CV term format because these values are often extracted programmatically from instrument files.\n\nLabel\n\nColumn: comment[label]\n\nOntology: PRIDE Ontology - Label\n\nDescribes the isotopic label applied to each sample.\n\nLabel-free: Use label free sample.\n\nTMT labels: TMT126, TMT127N, TMT127C, TMT128N, TMT128C, TMT129N, TMT129C, TMT130N, TMT130C, TMT131N, TMT131C, TMT132N, TMT132C, TMT133N, TMT133C, TMT134N, TMT134C, TMT135N\n\niTRAQ labels: iTRAQ113, iTRAQ114, iTRAQ115, iTRAQ116, iTRAQ117, iTRAQ118, iTRAQ119, iTRAQ121\n\nSILAC lab",
    ...
    "section": "Data File Metadata Guidelines",
    "keywords": "MS:1000044 PRIDE:0000592 PRIDE:0000594 MS2 mass analyzer MS:1000264 fractionation method MS:1001309 PRIDE:0000564 PRIDE:0000590 comment MS1 scan range MS:1001306 PRIDE:0000551 MS:1001303 MS:1001313 depletion collision energy scan window upper limit cleavage agent MS:1002523 instrument PRIDE:0000591 MS MS:1001917 modification parameters PRIDE:0000285 MS:1001045 scan window lower limit PRIDE:0000565 MS:1001251 PRIDE:0000553 PRIDE:0000561 label fraction identifier PRIDE:0000593 reduction reagent cleavage agent details fragment mass tolerance MS:1000081 MS:1000443 MS:1000084 alkylation reagent precursor mass tolerance dissociation method MS:1000484"
  },
  {
