...
const SEARCH_INDEX = [
  ...
  },
  {
    ...
    "section": "Core Specification",
    "keywords": "treatment tissue patient bmi MS:1001251 disease staging technology type PATO:0000461 organism EFO UBERON sex disease PRIDE:0000659 PRIDE:0000834 NCIT CLO grade proteomics data acquisition method fraction identifier comment organism part PRIDE:0000832 MS:1000484 modification parameters source name PRIDE:0000590 individual biological replicate developmental stage cell line PATO data file time point HANCESTRO assay name ancestry category factor value MS MONDO label PRIDE:0000831 cleavage agent details age pooled sample BTO dose PRIDE:0000833 CL instrument DOID biosample accession number cleavage agent tumor grade ... technical replicate cell type"
  },
  {
    "title": "Sample Metadata Guidelines",
    "content": "Sample Metadata Guidelines\n\nIntroduction\n\nThis document provides guidelines for annotating general sample metadata in SDRF-Proteomics format. These guidelines apply to samples from any organism (human, animal, plant).\n\nFor human-specific metadata (disease staging, comorbidities, treatment history), see Human Sample Metadata Guidelines.\n\nVersion 1.1.0 - 2026-01\n\nGeneral Formatting Conventions\n\nCapitalization Rules\n\nMost controlled vocabulary values should be lowercase:\n\n- Organism names: homo sapiens, mus musculus\n- Organism parts: blood, liver, brain\n- Sex values: male, female\n- Developmental stages: adult, embryonic\n- Disease names (general): breast carcinoma, type 2 diabetes mellitus\n\nExceptions (retain proper noun capitalization):\n\n- Disease names with proper nouns: Alzheimer disease, Parkinson disease\n- Ancestry categories (geographic populations): African, European, South Asian\n- Cell line names: HeLa, HEK293, K562\n\n Validators should normalize common capitalization variations (e.g., accept both Homo sapiens and homo sapiens), but submitters should use lowercase for consistency.\n\nReserved Values\n\nThe following reserved values can be used across multiple columns when specific data is unavailable:\n\nValue |When to Use |Example Columns\n\nnot available\nInformation was not collected or is unknown\nage, sex, ancestry category, disease\n\nnot applicable\nThe field does not apply to this sample type\norganism part (for cell lines), cell type (for whole organism)\n\nanonymized\nInformation exists but has been intentionally redacted for privacy protection (e.g., in clinical studies with de-identified patient data)\nage, sex, individual, ancestry category\n\npooled\nSample is pooled from multiple sources with different values\nbiological replicate, age, sex\n\n[IMPORTANT]\n====\nUse anonymized when the data exists but cannot be shared due to privacy requirements. This is distinct from not available (data was never collected) and provides important context for data reuse. For example, a clin",
    "url": "./metadata-guidelines/sample-metadata.html",
    "section": "Sample Metadata Guidelines",
    "keywords": "PATO:0000001 hs UBERON:0002113 CL:0000066 treatment ctrl tissue CL:0000084 patient bmi CL:0000235 CL:0000057 PATO:0000461 organism EFO MONDO:0100096 UBERON material type sex exclamation disease UBERON:0001969 xenograft comment UBERON:0002107 enrichment process MONDO:0004975 organism part spiked compound enrichment method source name mass CL:0000815 depletion individual biological replicate developmental stage cell line synthetic peptide UBERON:0000948 SIO:001012 PRIDE:0000837 PATO time point genotype MONDO:0005148 factor value CL:0000236 ancestry category MONDO MONDO:0004989 hfd compound UBERON:0000955 stress age smoking status UBERON:0000178 sample preparation dose CL DOID phenotype tissue supergroup CL:0000624 EFO:0000651 cell type"
  },
  {
    "title": "Sample Metadata Guidelines",
    "content": "Sample Metadata Guidelines\n\nIntroduction\n\nThis document provides guidelines for annotating general sample metadata in SDRF-Proteomics format. These guidelines apply to samples from any organism (human, animal, plant).\n\nFor human-specific metadata (disease staging, comorbidities, treatment history), see Human Sample Metadata Guidelines.\n\nVersion 1.1.0 - 2026-01\n\nGeneral Formatting Conventions\n\nCapitalization Rules\n\nMost controlled vocabulary values should be lowercase:\n\n- Organism names: homo sapiens, mus musculus\n- Organism parts: blood, liver, brain\n- Sex values: male, female\n- Developmental stages: adult, embryonic\n- Disease names (general): breast carcinoma, type 2 diabetes mellitus\n\nExceptions (retain proper noun capitalization):\n\n- Disease names with proper nouns: Alzheimer disease, Parkinson disease\n- Ancestry categories (geographic populations): African, European, South Asian\n- Cell line names: HeLa, HEK293, K562\n\n Validators should normalize common capitalization variations (e.g., accept both Homo sapiens and homo sapiens), but submitters should use lowercase for consistency.\n\nReserved Values\n\nThe following reserved values can be used across multiple columns when specific data is unavailable:\n\nValue |When to Use |Example Columns\n\nnot available\nInformation was not collected or is unknown\nage, sex, ancestry category, disease\n\nnot applicable\nThe field does not apply to this sample type\norganism part (for cell lines), cell type (for whole organism)\n\nanonymized\nInformation exists but has been intentionally redacted for privacy protection (e.g., in clinical studies with de-identified patient data)\nage, sex, individual, ancestry category\n\npooled\nSample is pooled from multiple sources with different values\nbiological replicate, age, sex\n\n[IMPORTANT]\n====\nUse anonymized when the data exists but cannot be shared due to privacy requirements. This is distinct from not available (data was never collected) and provides important context for data reuse. For example, a clin",
    ...
    "section": "Sample Metadata Guidelines",
    "keywords": "PATO:0000001 UBERON:0002113 CL:0000066 treatment tissue CL:0000084 patient bmi CL:0000235 CL:0000057 PATO:0000461 organism EFO MONDO:0100096 UBERON material type sex disease UBERON:0001969 xenograft comment UBERON:0002107 enrichment process MONDO:0004975 organism part spiked compound enrichment method source name mass CL:0000815 depletion individual biological replicate developmental stage cell line synthetic peptide UBERON:0000948 SIO:001012 PRIDE:0000837 PATO time point genotype MONDO:0005148 factor value CL:0000236 ancestry category MONDO MONDO:0004989 compound UBERON:0000955 age smoking status UBERON:0000178 sample preparation dose CL DOID phenotype tissue supergroup CL:0000624 EFO:0000651 cell type"
  },
  {
    "title": "Data File Metadata Guidelines",
    "content": "Data File Metadata Guidelines\n\nIntroduction\n\nThis document provides detailed guidelines for data file metadata fields that require specific formatting or have complex standardization requirements. For basic field descriptions, see the main SDRF-Proteomics specification.\n\nVersion 1.0.0 - 2025-01\n\nCV Term Format\n\nFor data file metadata columns that reference ontology terms, use the structured CV term format:\n\nNT={term name};AC={accession}\n\nExamples:\n\n- Dissociation method: NT=HCD;AC=PRIDE:0000590\n- Fractionation method: NT=High-pH reversed-phase chromatography;AC=PRIDE:0000564\n- Instrument: NT=Q Exactive HF;AC=MS:1002523\n- Label: NT=TMT126;AC=PRIDE:0000285\n\nWhy use the structured format?\n\n1. Automated annotation: Many data file properties (instrument, acquisition method, dissociation method) can be automatically determined by software from raw files.\n2. Validation: Accession numbers enable automated validation against ontologies.\n3. Interoperability: Structured terms are unambiguous across different tools and databases.\n\n Unlike sample metadata (characteristics) which are typically annotated manually using simple term names, data file metadata benefits from the structured CV term format because these values are often extracted programmatically from instrument files.\n\nLabel\n\nColumn: comment[label]\n\nOntology: PRIDE Ontology - Label\n\nDescribes the isotopic label applied to each sample.\n\nLabel-free: Use label free sample.\n\nTMT labels: TMT126, TMT127N, TMT127C, TMT128N, TMT128C, TMT129N, TMT129C, TMT130N, TMT130C, TMT131N, TMT131C, TMT132N, TMT132C, TMT133N, TMT133C, TMT134N, TMT134C, TMT135N\n\niTRAQ labels: iTRAQ113, iTRAQ114, iTRAQ115, iTRAQ116, iTRAQ117, iTRAQ118, iTRAQ119, iTRAQ121\n\nSILAC labels: SILAC light, SILAC medium, SILAC heavy\n\nMS2 Mass Analyzer\n\nColumn: comment[MS2 mass analyzer]\n\nOntology: PSI-MS - Mass analyzer type (MS:1000443)\n\nSpecifies the analyzer used for MS2 scans. Important for hybrid instruments.\n\nCommon values:\n\nAnalyzer |Accession\n\norbitrap |MS:100",
    "url": "./metadata-guidelines/data-file-metadata.html",
    "section": "Data File Metadata Guidelines",
    "keywords": "MS:1001303 scan window upper limit fractionation method MS:1000133 MS:1000598 scan window lower limit MS:1001251 PRIDE:0000553 MS:1000264 MS:1002631 reduction reagent dissociation method fragment mass tolerance PRIDE:0000561 MS1 scan range exclamation MS:1000443 fraction identifier comment MS:1002523 modification parameters MS:1000484 PRIDE:0000590 depletion alkylation reagent collision energy PRIDE:0000564 MS:1000084 MS:1001313 MS:1001309 MS MS:1000422 MS:1001917 PRIDE:0000551 label MS:1001306 cleavage agent details MS:1001045 MS:1000081 precursor mass tolerance instrument PRIDE:0000285 cleavage agent MS2 mass analyzer MS:1003246 PRIDE:0000565"
  },
  {
    "title": "Data File Metadata Guidelines",
    "content": "Data File Metadata Guidelines\n\nIntroduction\n\nThis document provides detailed guidelines for data file metadata fields that require specific formatting or have complex standardization requirements. For basic field descriptions, see the main SDRF-Proteomics specification.\n\nVersion 1.0.0 - 2025-01\n\nCV Term Format\n\nFor data file metadata columns that reference ontology terms, use the structured CV term format:\n\nNT={term name};AC={accession}\n\nExamples:\n\n- Dissociation method: NT=HCD;AC=PRIDE:0000590\n- Fractionation method: NT=High-pH reversed-phase chromatography;AC=PRIDE:0000564\n- Instrument: NT=Q Exactive HF;AC=MS:1002523\n- Label: NT=TMT126;AC=PRIDE:0000285\n\nWhy use the structured format?\n\n1. Automated annotation: Many data file properties (instrument, acquisition method, dissociation method) can be automatically determined by software from raw files.\n2. Validation: Accession numbers enable automated validation against ontologies.\n3. Interoperability: Structured terms are unambiguous across different tools and databases.\n\n Unlike sample metadata (characteristics) which are typically annotated manually using simple term names, data file metadata benefits from the structured CV term format because these values are often extracted programmatically from instrument files.\n\nLabel\n\nColumn: comment[label]\n\nOntology: PRIDE Ontology - Label\n\nDescribes the isotopic label applied to each sample.\n\nLabel-free: Use label free sample.\n\nTMT labels: TMT126, TMT127N, TMT127C, TMT128N, TMT128C, TMT129N, TMT129C, TMT130N, TMT130C, TMT131N, TMT131C, TMT132N, TMT132C, TMT133N, TMT133C, TMT134N, TMT134C, TMT135N\n\niTRAQ labels: iTRAQ113, iTRAQ114, iTRAQ115, iTRAQ116, iTRAQ117, iTRAQ118, iTRAQ119, iTRAQ121\n\nSILAC labels: SILAC light, SILAC medium, SILAC heavy\n\nMS2 Mass Analyzer\n\nColumn: comment[MS2 mass analyzer]\n\nOntology: PSI-MS - Mass analyzer type (MS:1000443)\n\nSpecifies the analyzer used for MS2 scans. Important for hybrid instruments.\n\nCommon values:\n\nAnalyzer |Accession\n\norbitrap |MS:100",
    "url": "./metadata-guidelines/data-file-metadata.html#data-file-metadata-guidelines",
    "section": "Data File Metadata Guidelines",
    "keywords": "MS:1001303 scan window upper limit fractionation method MS:1000133 MS:1000598 scan window lower limit MS:1001251 PRIDE:0000553 MS:1000264 MS:1002631 reduction reagent dissociation method fragment mass tolerance PRIDE:0000561 MS1 scan range MS:1000443 fraction identifier comment MS:1002523 modification parameters MS:1000484 PRIDE:0000590 depletion alkylation reagent collision energy PRIDE:0000564 MS:1000084 MS:1001313 MS:1001309 MS MS:1000422 MS:1001917 PRIDE:0000551 label MS:1001306 cleavage agent details MS:1001045 MS:1000081 precursor mass tolerance instrument PRIDE:0000285 cleavage agent MS2 mass analyzer MS:1003246 PRIDE:0000565"
  },
  {
  ...
  {
    "title": "Column: age",
    "content": "age characteristics human, cell-lines pattern: Y/M/D format, anonymized, or pooled",
