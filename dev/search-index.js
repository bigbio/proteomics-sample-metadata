...
const SEARCH_INDEX = [
  {
    ...
    "keywords": "technology type exclamation ctrl PRIDE:0000833 PRIDE:0000832 PATO:0000461 file your MS:1001251 comment DOID proteomics data acquisition method individual UBERON proteomic profiling by mass spectrometry CL sex PRIDE:0000659 fraction identifier PRIDE:0000834 drug developmental stage instrument ... EFO sample cleavage agent tumor grade dose HANCESTRO data file time point tissue cleavage agent details PATO age organism CLO PRIDE:0000831 patient bmi BTO MONDO ancestry category dia_scan disease staging organism part MS disease NCIT cell type biosample accession number treatment modification parameters label factor value protein PRIDE:0000590 characteristics source name grade assay name biological replicate cell line technical replicate MS:1000484 pooled sample"
  },
  {
    "title": "Sample and Data Relationship Format for Proteomics (SDRF-Proteomics)",
    "content": "// suppress inspection \"GrazieInspection\" for whole file\nSample and Data Relationship Format for Proteomics (SDRF-Proteomics)\n\n//only works on some backends, not HTML\n\n//use style like Section 1 when referencing within the document.\n\n//GitHub specific settings\n\nStatus of this document\n\nThis document provides information to the proteomics community about a proposed standard for sample metadata annotations in public repositories called Sample and Data Relationship Format (SDRF)-Proteomics. Distribution is unlimited.\n\nVersion v1.1.0 - 2025-01\n\nAbstract\n\nThe Human Proteome Organisation (HUPO) Proteomics Standards Initiative (PSI) defines community standards for data representation in proteomics to facilitate data comparison, exchange, and verification. This document presents a specification for the Sample and Data Relationship Format (SDRF-Proteomics).\n\nFurther detailed information, including any updates to this document, implementations, and examples is available at SDRF GitHub Repository. The official PSI web page for the document is: HUPO-PSI SDRF.\n\nMotivation\n\nMany resources have emerged that provide raw or integrated proteomics data in the public domain. If these are valuable individually, their integration through re-analysis represents a huge asset for the community .\n\nUnfortunately, proteomics experimental design and sample related information are often missing in public repositories or stored in very diverse ways and formats. For example:\n\n- The CPTAC Consortium provides for every dataset a set of Excel files with the information on each sample including tumor size, origin, but also how every sample is related to a specific raw file (e.g. instrument configuration parameters).\n\n- As a resource routinely re-analysing public datasets, ProteomicsDB captures for each sample in the database a minimum number of properties to describe the sample and the related experimental protocol such as tissue, digestion method and instrument.\n\nSuch heterogeneity often prevents dat",
    ...
    "section": "Core Specification",
    "keywords": "technology type PRIDE:0000833 PRIDE:0000832 PATO:0000461 MS:1001251 comment DOID proteomics data acquisition method individual UBERON CL sex PRIDE:0000659 fraction identifier PRIDE:0000834 developmental stage instrument ... EFO cleavage agent tumor grade dose HANCESTRO data file time point tissue cleavage agent details PATO age organism CLO PRIDE:0000831 patient bmi BTO MONDO ancestry category disease staging organism part MS disease NCIT cell type biosample accession number treatment modification parameters label factor value PRIDE:0000590 source name grade assay name biological replicate cell line technical replicate MS:1000484 pooled sample"
  },
  {
    ...
    "keywords": "tissue supergroup xenograft exclamation UBERON:0001969 phenotype PATO:0000461 EFO:0000651 DOID CL:0000624 individual CL:0000084 UBERON CL sex CL:0000815 UBERON:0000955 smoking status developmental stage EFO CL:0000235 depletion synthetic peptide CL:0000066 dose UBERON:0000948 tissue time point PATO age organism SIO:001012 patient bmi CL:0000057 MONDO PRIDE:0000837 organism part MONDO:0004989 disease treatment cell type factor value material type CL:0000236 UBERON:0002107 PATO:0000047 spiked compound enrichment process source name mass compound cell line genotype"
  },
  {
    "title": "Sample Metadata Guidelines",
    "content": "Sample Metadata Guidelines\n\nIntroduction\n\nThis document provides guidelines for annotating general sample metadata in SDRF-Proteomics format. These guidelines apply to samples from any organism (human, animal, plant, microorganism).\n\nFor human-specific metadata (disease staging, comorbidities, treatment history), see Human Template.\n\nVersion 1.1.0 - 2026-01\n\nBest Practices\n\n1. Use lowercase for all controlled vocabulary values (except proper nouns in disease names).\n2. Use ontology terms mapped to MONDO (diseases), CL (cell types), UBERON (anatomy), PATO (phenotypes).\n3. Be consistent with format across all samples in a dataset.\n4. Document unknowns using not available (unknown) or not applicable (not relevant) - never leave cells empty.\n5. Validate before submission using sdrf-pipelines to check ontology mappings.\n\nGeneral Formatting Conventions\n\nCapitalization Rules\n\nMost controlled vocabulary values are recommended to be lowercase:\n\n- Organism names: homo sapiens, mus musculus\n- Organism parts: blood, liver, brain\n- Sex values: male, female\n\nExceptions (retain proper noun capitalization):\n\n- Ancestry categories (geographic populations): African, European, South Asian\n- Cell line names: HeLa, HEK293, K562\n\n Validators should normalize common capitalization variations (e.g., accept both Homo sapiens and homo sapiens), but submitters should use lowercase for consistency.\n\nOrganism\n\nColumn: characteristics[organism]\n\nOntology: NCBI Taxonomy (NCBITaxon)\n\nUse the scientific name in lowercase. The validator will map to the correct ontology term.\n\nValue |NCBITaxon ID |Description\n\nhomo sapiens |NCBITaxon:9606 |Human\nmus musculus |NCBITaxon:10090 |Mouse\n\nOrganism Part / Tissue\n\nColumn: characteristics[organism part]\n\nOntology: UBERON for mammals/vertebrates, Plant Ontology (PO) for plants, FlyBase Anatomy (FBbt) for Drosophila.\n\nUse lowercase for all values. For cell line samples, use not applicable or specify the tissue of origin (e.g., cervix for HeLa).\n\n[NOTE]\n====\nDo ",
    ...
    "section": "Sample Metadata Guidelines",
    "keywords": "tissue supergroup xenograft UBERON:0001969 phenotype PATO:0000461 EFO:0000651 DOID CL:0000624 individual CL:0000084 UBERON CL sex CL:0000815 UBERON:0000955 smoking status developmental stage EFO CL:0000235 depletion synthetic peptide CL:0000066 dose UBERON:0000948 tissue time point PATO age organism SIO:001012 patient bmi CL:0000057 MONDO PRIDE:0000837 organism part MONDO:0004989 disease treatment cell type factor value material type CL:0000236 UBERON:0002107 PATO:0000047 spiked compound enrichment process source name mass compound cell line genotype"
  },
  {
