...
const SEARCH_INDEX = [
  {
    ...
    "keywords": "cell line proteomics data acquisition method organism part assay name pooled sample technology type disease staging CL organism source name ... biological replicate PRIDE:0000833 age label instrument file your factor value ancestry category characteristics sample HANCESTRO tumor grade PRIDE:0000590 cleavage agent details PRIDE:0000834 technical replicate time point dia_scan UBERON exclamation proteomic profiling by mass spectrometry BTO patient bmi protein MS DOID dose drug ctrl data file PATO:0000461 tissue cleavage agent sex cell type PRIDE:0000831 disease PATO fraction identifier comment PRIDE:0000659 PRIDE:0000832 individual grade MS:1000484 NCIT treatment EFO MS:1001251 modification parameters developmental stage CLO MONDO biosample accession number"
  },
  {
    "title": "Sample and Data Relationship Format for Proteomics (SDRF-Proteomics)",
    "content": "// suppress inspection \"GrazieInspection\" for whole file\nSample and Data Relationship Format for Proteomics (SDRF-Proteomics)\n\n//only works on some backends, not HTML\n\n//use style like Section 1 when referencing within the document.\n\n//GitHub specific settings\n\nStatus of this document\n\nThis document provides information to the proteomics community about a proposed standard for sample metadata annotations in public repositories called Sample and Data Relationship Format (SDRF)-Proteomics. Distribution is unlimited.\n\nVersion v1.1.0 - 2025-01\n\nAbstract\n\nThe Human Proteome Organisation (HUPO) Proteomics Standards Initiative (PSI) defines community standards for data representation in proteomics to facilitate data comparison, exchange, and verification. This document presents a specification for the Sample and Data Relationship Format (SDRF-Proteomics).\n\nFurther detailed information, including any updates to this document, implementations, and examples is available at SDRF GitHub Repository. The official PSI web page for the document is: HUPO-PSI SDRF.\n\nMotivation\n\nMany resources have emerged that provide raw or integrated proteomics data in the public domain. If these are valuable individually, their integration through re-analysis represents a huge asset for the community .\n\nUnfortunately, proteomics experimental design and sample related information are often missing in public repositories or stored in very diverse ways and formats. For example:\n\n- The CPTAC Consortium provides for every dataset a set of Excel files with the information on each sample including tumor size, origin, but also how every sample is related to a specific raw file (e.g. instrument configuration parameters).\n\n- As a resource routinely re-analysing public datasets, ProteomicsDB captures for each sample in the database a minimum number of properties to describe the sample and the related experimental protocol such as tissue, digestion method and instrument.\n\nSuch heterogeneity often prevents dat",
    ...
    "section": "Core Specification",
    "keywords": "cell line proteomics data acquisition method organism part assay name pooled sample technology type disease staging CL organism source name ... biological replicate PRIDE:0000833 age label instrument ancestry category factor value HANCESTRO tumor grade PRIDE:0000590 cleavage agent details PRIDE:0000834 technical replicate time point UBERON BTO patient bmi MS DOID dose data file PATO:0000461 tissue cleavage agent sex cell type PRIDE:0000831 disease PATO fraction identifier comment PRIDE:0000659 PRIDE:0000832 individual grade MS:1000484 NCIT treatment EFO MS:1001251 modification parameters developmental stage CLO MONDO biosample accession number"
  },
  {
    ...
    "keywords": "cell line CL:0000815 organism part CL:0000057 mass CL UBERON:0000955 organism source name depletion age CL:0000084 CL:0000236 factor value smoking status UBERON:0002107 spiked compound enrichment process CL:0000624 genotype compound time point CL:0000066 MONDO:0004989 UBERON exclamation PRIDE:0000837 patient bmi CL:0000235 DOID dose tissue PATO:0000461 PATO:0000047 sex synthetic peptide xenograft cell type disease tissue supergroup PATO material type SIO:001012 developmental stage phenotype individual treatment EFO MONDO UBERON:0001969 EFO:0000651"
  },
  {
    "title": "Sample Metadata Guidelines",
    "content": "Sample Metadata Guidelines\n\nIntroduction\n\nThis document provides guidelines for annotating general sample metadata in SDRF-Proteomics format. These guidelines apply to samples from any organism (human, animal, plant, microorganism).\n\nFor human-specific metadata (disease staging, comorbidities, treatment history), see Human Sample Metadata Guidelines.\n\nVersion 1.1.0 - 2026-01\n\nBest Practices\n\n1. Use lowercase for all controlled vocabulary values (except proper nouns in disease names).\n2. Use ontology terms mapped to MONDO (diseases), CL (cell types), UBERON (anatomy), PATO (phenotypes).\n3. Be consistent with format across all samples in a dataset.\n4. Document unknowns using not available (unknown) or not applicable (not relevant) - never leave cells empty.\n5. Validate before submission using sdrf-pipelines to check ontology mappings.\n\nGeneral Formatting Conventions\n\nCapitalization Rules\n\nMost controlled vocabulary values are recommended to be lowercase:\n\n- Organism names: homo sapiens, mus musculus\n- Organism parts: blood, liver, brain\n- Sex values: male, female\n\nExceptions (retain proper noun capitalization):\n\n- Ancestry categories (geographic populations): African, European, South Asian\n- Cell line names: HeLa, HEK293, K562\n\n Validators should normalize common capitalization variations (e.g., accept both Homo sapiens and homo sapiens), but submitters should use lowercase for consistency.\n\nOrganism\n\nColumn: characteristics[organism]\n\nOntology: NCBI Taxonomy (NCBITaxon)\n\nUse the scientific name in lowercase. The validator will map to the correct ontology term.\n\nValue |NCBITaxon ID |Description\n\nhomo sapiens |NCBITaxon:9606 |Human\nmus musculus |NCBITaxon:10090 |Mouse\n\nOrganism Part / Tissue\n\nColumn: characteristics[organism part]\n\nOntology: UBERON for mammals/vertebrates, Plant Ontology (PO) for plants, FlyBase Anatomy (FBbt) for Drosophila.\n\nUse lowercase for all values. For cell line samples, use not applicable or specify the tissue of origin (e.g., cervix for HeLa)",
    ...
    "section": "Sample Metadata Guidelines",
    "keywords": "cell line CL:0000815 organism part CL:0000057 mass CL UBERON:0000955 organism source name depletion age CL:0000084 CL:0000236 factor value smoking status UBERON:0002107 spiked compound enrichment process CL:0000624 genotype compound time point CL:0000066 MONDO:0004989 UBERON PRIDE:0000837 patient bmi CL:0000235 DOID dose tissue PATO:0000461 PATO:0000047 sex synthetic peptide xenograft cell type disease tissue supergroup PATO material type SIO:001012 developmental stage phenotype individual treatment EFO MONDO UBERON:0001969 EFO:0000651"
  },
  {
    ...
    "keywords": "MS:1000081 MS:1000264 PRIDE:0000551 dissociation method MS:1001917 MS:1001303 MS:1000084 MS:1000044 depletion label MS2 mass analyzer reduction reagent fragment mass tolerance MS:1001313 instrument scan window lower limit PRIDE:0000593 PRIDE:0000561 MS:1000443 PRIDE:0000565 PRIDE:0000592 MS:1001306 MS:1001045 PRIDE:0000590 cleavage agent details precursor mass tolerance MS1 scan range exclamation PRIDE:0000594 fractionation method PRIDE:0000553 MS PRIDE:0000591 cleavage agent PRIDE:0000564 fraction identifier comment MS:1002523 scan window upper limit PRIDE:0000285 MS:1000484 alkylation reagent MS:1001251 modification parameters MS:1001309 collision energy"
  },
  {
    "title": "Data File Metadata Guidelines",
    "content": "Data File Metadata Guidelines\n\nIntroduction\n\nThis document provides detailed guidelines for data file metadata fields that require specific formatting or have complex standardization requirements. For basic field descriptions, see the main SDRF-Proteomics specification.\n\nVersion 1.0.0 - 2025-01\n\nBest Practices\n\n1. Use ontology terms - Prefer PSI-MS and PRIDE ontology terms for labels and enzymes.\n2. Document modifications - Include all expected modifications with UNIMOD accessions.\n3. Provide mass tolerances - Include precursor and fragment tolerances for reproducibility.\n\nCV Term Format\n\nFor data file metadata columns that reference ontology terms, use the structured CV term format:\n\nNT={term name};AC={accession}\n\nExamples:\n\n- Dissociation method: NT=HCD;AC=PRIDE:0000590\n- Fractionation method: NT=High-pH reversed-phase chromatography;AC=PRIDE:0000564\n- Instrument: NT=Q Exactive HF;AC=MS:1002523\n- Label: NT=TMT126;AC=PRIDE:0000285\n\nWhy use the structured format?\n\n1. Automated annotation: Many data file properties (instrument, acquisition method, dissociation method) can be automatically determined by software from raw files.\n2. Validation: Accession numbers enable automated validation against ontologies.\n3. Interoperability: Structured terms are unambiguous across different tools and databases.\n\n Unlike sample metadata (characteristics) which are typically annotated manually using simple term names, data file metadata benefits from the structured CV term format because these values are often extracted programmatically from instrument files.\n\nLabel\n\nColumn: comment[label]\n\nOntology: PRIDE Ontology - Label\n\nDescribes the isotopic label applied to each sample.\n\nLabel-free: Use label free sample.\n\nTMT labels: TMT126, TMT127N, TMT127C, TMT128N, TMT128C, TMT129N, TMT129C, TMT130N, TMT130C, TMT131N, TMT131C, TMT132N, TMT132C, TMT133N, TMT133C, TMT134N, TMT134C, TMT135N\n\niTRAQ labels: iTRAQ113, iTRAQ114, iTRAQ115, iTRAQ116, iTRAQ117, iTRAQ118, iTRAQ119, iTRAQ121\n\nSILAC lab",
    ...
    "section": "Data File Metadata Guidelines",
    "keywords": "MS:1000081 MS:1000264 PRIDE:0000551 dissociation method MS:1001917 MS:1001303 MS:1000084 MS:1000044 depletion label MS2 mass analyzer reduction reagent fragment mass tolerance MS:1001313 instrument scan window lower limit PRIDE:0000593 PRIDE:0000561 MS:1000443 PRIDE:0000565 PRIDE:0000592 MS:1001306 MS:1001045 PRIDE:0000590 cleavage agent details precursor mass tolerance MS1 scan range PRIDE:0000594 fractionation method PRIDE:0000553 MS PRIDE:0000591 cleavage agent PRIDE:0000564 fraction identifier comment MS:1002523 scan window upper limit PRIDE:0000285 MS:1000484 alkylation reagent MS:1001251 modification parameters MS:1001309 collision energy"
  },
  {
