...
const SEARCH_INDEX = [
  {
    ...
    "keywords": "dose factor value individual fraction identifier biological replicate PATO PRIDE:0000832 PRIDE:0000590 protein EFO grade age comment pooled sample tissue MS:1001251 cleavage agent sex instrument data file PATO:0000461 treatment cell type NCIT organism PRIDE:0000834 MS MS:1000484 cell line modification parameters CL UBERON characteristics technical replicate developmental stage ... organism part assay name biosample accession number technology type CLO cleavage agent details HANCESTRO DOID disease file your source name ctrl proteomics data acquisition method disease staging label tool metadata ancestry category exclamation MONDO drug dia_scan tumor grading BTO time point base sample PRIDE:0000831 PRIDE:0000659"
  },
  {
    "title": "Sample and Data Relationship Format for Proteomics (SDRF-Proteomics)",
    "content": "// suppress inspection \"GrazieInspection\" for whole file\nSample and Data Relationship Format for Proteomics (SDRF-Proteomics)\n\n//only works on some backends, not HTML\n\n//use style like Section 1 when referencing within the document.\n\n//GitHub specific settings\n\nStatus of this document\n\nThis document provides information to the proteomics community about a proposed standard for sample metadata annotations in public repositories called Sample and Data Relationship Format (SDRF)-Proteomics. Distribution is unlimited.\n\nVersion v1.1.0 - 2026-01\n\nAbstract\n\nThe Human Proteome Organisation (HUPO) Proteomics Standards Initiative (PSI) defines community standards for data representation in proteomics to facilitate data comparison, exchange, and verification. This document presents a specification for the Sample and Data Relationship Format (SDRF-Proteomics).\n\nFurther detailed information, including any updates to this document, implementations, and examples is available at SDRF GitHub Repository. The official PSI web page for the document is: HUPO-PSI SDRF.\n\nMotivation\n\nMany resources have emerged that provide raw or integrated proteomics data in the public domain. If these are valuable individually, their integration through re-analysis represents a huge asset for the community .\n\nUnfortunately, proteomics experimental design and sample related information are often missing in public repositories or stored in very diverse ways and formats. For example:\n\n- The CPTAC Consortium provides for every dataset a set of Excel files with the information on each sample including tumor size, origin, but also how every sample is related to a specific raw file (e.g. instrument configuration parameters).\n\n- As a resource routinely re-analysing public datasets, ProteomicsDB captures for each sample in the database a minimum number of properties to describe the sample and the related experimental protocol such as tissue, digestion method and instrument.\n\nSuch heterogeneity often prevents dat",
    ...
    "section": "Core Specification",
    "keywords": "dose factor value individual fraction identifier biological replicate PATO PRIDE:0000832 PRIDE:0000590 EFO grade age comment pooled sample tissue MS:1001251 cleavage agent sex instrument data file PATO:0000461 treatment cell type NCIT organism PRIDE:0000834 MS MS:1000484 cell line modification parameters CL UBERON developmental stage technical replicate ... organism part assay name biosample accession number technology type CLO cleavage agent details HANCESTRO DOID disease source name proteomics data acquisition method disease staging label tool metadata ancestry category MONDO tumor grading BTO time point PRIDE:0000831 PRIDE:0000659"
  },
  {
    ...
    "keywords": "dose UBERON:0001969 UBERON:0000955 smoking status factor value SIO:001012 individual PATO UBERON:0000948 EFO age tissue supergroup depletion enrichment process CL:0000235 tissue CL:0000815 sex MONDO:0004989 synthetic peptide PATO:0000461 treatment cell type organism patient bmi cell line CL:0000624 xenograft CL UBERON material type developmental stage spiked compound organism part UBERON:0002107 DOID disease phenotype source name genotype PRIDE:0000837 CL:0000057 compound exclamation MONDO CL:0000066 PATO:0000047 mass time point CL:0000084 EFO:0000651 CL:0000236"
  },
  {
    "title": "Sample Metadata Guidelines",
    "content": "Sample Metadata Guidelines\n\nIntroduction\n\nThis document provides guidelines for annotating general sample metadata in SDRF-Proteomics format. These guidelines apply to samples from any organism (human, animal, plant, microorganism).\n\nFor human-specific metadata (disease staging, comorbidities, treatment history), see Human Template.\n\nVersion 1.1.0 - 2026-01\n\nBest Practices\n\n1. Use lowercase for all controlled vocabulary values (except proper nouns in disease names).\n2. Use ontology terms mapped to MONDO (diseases), CL (cell types), UBERON (anatomy), PATO (phenotypes).\n3. Be consistent with format across all samples in a dataset.\n4. Document unknowns using not available (unknown) or not applicable (not relevant) - never leave cells empty.\n5. Validate before submission using sdrf-pipelines to check ontology mappings.\n\nGeneral Formatting Conventions\n\nCapitalization Rules\n\nMost controlled vocabulary values are recommended to be lowercase:\n\n- Organism names: homo sapiens, mus musculus\n- Organism parts: blood, liver, brain\n- Sex values: male, female\n\nExceptions (retain proper noun capitalization):\n\n- Ancestry categories (geographic populations): African, European, South Asian\n- Cell line names: HeLa, HEK293, K562\n\n Validators should normalize common capitalization variations (e.g., accept both Homo sapiens and homo sapiens), but submitters should use lowercase for consistency.\n\nOrganism\n\nColumn: characteristics[organism]\n\nOntology: NCBI Taxonomy (NCBITaxon)\n\nUse the scientific name in lowercase. The validator will map to the correct ontology term.\n\nValue |NCBITaxon ID |Description\n\nhomo sapiens |NCBITaxon:9606 |Human\nmus musculus |NCBITaxon:10090 |Mouse\n\nOrganism Part / Tissue\n\nColumn: characteristics[organism part]\n\nOntology: UBERON for mammals/vertebrates, Plant Ontology (PO) for plants, FlyBase Anatomy (FBbt) for Drosophila.\n\nUse lowercase for all values. For cell line samples, use not applicable or specify the tissue of origin (e.g., cervix for HeLa).\n\n[NOTE]\n====\nDo ",
    ...
    "section": "Sample Metadata Guidelines",
    "keywords": "dose UBERON:0001969 UBERON:0000955 smoking status factor value SIO:001012 individual PATO UBERON:0000948 EFO age tissue supergroup depletion enrichment process CL:0000235 tissue CL:0000815 sex MONDO:0004989 synthetic peptide PATO:0000461 treatment cell type organism patient bmi cell line CL:0000624 xenograft CL UBERON material type developmental stage spiked compound organism part UBERON:0002107 DOID disease phenotype source name genotype PRIDE:0000837 CL:0000057 compound MONDO CL:0000066 PATO:0000047 mass time point CL:0000084 EFO:0000651 CL:0000236"
  },
  {
