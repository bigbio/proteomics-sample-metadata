...
The *Sample and Data Relationship Format (SDRF)  (SDRF) for Proteomics* project aim to represent sample metadata in proteomics experiments and the relation with the Data files (e.g. RAW files), including the annotation of:
