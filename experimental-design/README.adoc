...
The Sample metadata has different *Categories/Headings*  to organize all the attributes of the Sample. These categories helps

|===
|Property        | Mandatory/Optional | Cardinality | Description

|Source  Name    | Optional           | 1           | The Sample name.
|Sample ID       | Mandatory          | 1           | A sample identifier provided by the submitter.
...
|Factor Value    | Optional           | 0..*        | “Factor Value” columns should indicate which experimental factor / variable are use to perform the quantitative data analysis. The “Factor Value” columns should occur after all Characteristics and the attributes of the samples.
|===
