...
A mountain sunset
[#img-sunset]
[caption="SDRF for proteomics in Nutshell: ",link=https://github.com/bigbio/proteomics-metadata-standard/raw/master/experimental-design/images/sdrf-nutshell.png]
image::sdrf-nutshell.png[Nutshell,300,200]
