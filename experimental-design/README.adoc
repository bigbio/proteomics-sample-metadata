...
|Characteristics [Organism]              | icon:heart[size=2x] |M            |M                |M       |M           |
...
|Characteristics [Cell type] *           | M              |M            |M                |M       |M           |
|Characteristics [Individual]            | O              |O            |O                |O       |            |
|Characteristics [Cell line Code]        |                |             |                 |        |M           |
|===
