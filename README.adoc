...
As part of our efforts toward delivering open and inclusive science, we follow the https://www.contributor-covenant.org[Contributor Convenant] link:docs/CODE_OF_CONDUCT.md[Code of Conduct for Open Source Projects].
