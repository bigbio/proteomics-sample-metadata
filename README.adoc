...
image::https://flat.badgen.net/github/license/bigbio/proteomics-metadata-standard[link="https://github.com/bigbio/proteomics-metadata-standard/blob/master/LICENSE"]
image::https://flat.badgen.net/github/open-issues/bigbio/proteomics-metadata-standard[link="https://github.com/bigbio/proteomics-metadata-standard/issues"]
image::https://flat.badgen.net/github/open-prs/bigbio/proteomics-metadata-standard[link="https://github.com/bigbio/proteomics-metadata-standard/pulls"]
image::https://flat.badgen.net/github/contributors/bigbio/proteomics-metadata-standard[]
image::https://flat.badgen.net/github/watchers/bigbio/proteomics-metadata-standard[]
