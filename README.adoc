...
- Julian Uszkoreit (Ruhr University Bochum, Center for Protein Diagnostics (PRODI), Medical Proteome Analysis, Germany, and Ruhr University Bochum, Medical Faculty, Medizinisches Proteom-Center, Germany)
